...
export default function SettingsPage() {
    ...
    useEffect(() => {
        if (!user && typeof window !== 'undefined') {
            // Let auth context handle redirect or loading
            return;
        }
                    ...
                    <div className="settings-sidebar">
                        ...
                        <nav className="settings-nav">
                            ...
                            >
                                ...
                                <span className="nav-text">{t('account') || 'Account'}</span>
                            ...
                            >
                                ...
                                <span className="nav-text">{t('notificationsSettings') || 'Notifications'}</span>
                                <span className="nav-chevron"><ChevronRightIcon size={16} /></span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="nav-text">{t('privacy') || 'Privacy'}</span>
                                <span className="nav-chevron"><ChevronRightIcon size={16} /></span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="nav-text">{t('billing') || 'Billing'}</span>
                                <span className="nav-chevron"><ChevronRightIcon size={16} /></span>
                            </button>
                            <button
